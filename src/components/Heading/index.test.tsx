...
describe('<Heading />', () => {
    ...
    it('should render a heading with a primary line color', () => {
        renderWithTheme(<Heading lineColor="primary" lineBottom lineLeft>Won Games</Heading>)
    ...
    it('should render a heading with a secondary line color', () => {
        renderWithTheme(<Heading lineColor="secondary" lineBottom lineLeft>Won Games</Heading>)
